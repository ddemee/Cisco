...
<html lang="en">
  <head>
    ...
    <!-- site metas -->
    <title>Limmat Taxi - Taxiunternehmen und Limousinenservice contact us </title>
...
<body>
      ...
      <div class="container">
        <div class="language-menu">
          <ul class="language-bar">
            <li><a href="https://limmat-taxi.at/ger/contactus">GER</a></li>
            <li><a class="active" href="https://limmat-taxi.at/eng/contactus">ENG</a></li>
            <li><a href="https://limmat-taxi.at/rus/contactus">RUS</a></li>
           </ul>
        </div>
          <nav>
    ...
    <section id="thanks" >
        <div class="container">
          ...
          <h1>Thanks you</h1>
          <h2>Thank you our operator will reply to you soon</h2>
        </div>
    </section>
    <!-- FOOTER -->
    <footer id="footer">
